...
| 7 | Agenda — **sous-lot 1/3 fait, 2026-09-23** | `CalendrierDashboardV1.tsx`/`CalendrierDashboardV2.tsx` + `CalendrierDashboard.tsx` en point de branchement | agenda du jour en LECTURE SEULE (bandeau de 7 jours, temps de route estimé, créneaux libres, résumé) — sous-lots 2 (fiche de rendez-vous actionnable : statut/reprogrammation/note/facture, + lien de notification `?rdv=`) et 3 (RDV manuel, congés) pas faits, voir TODO.md pour le détail exact |
