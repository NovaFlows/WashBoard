...
// Réseaux sociaux du pied de page. Comptes confirmés (2026-09-15) : Instagram
// et TikTok. Le tableau est conçu pour encaisser un 3e/4e réseau plus tard
// sans changement de layout (flex + gap, pas de largeur figée).
