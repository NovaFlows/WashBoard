import { Users, Percent, Activity, Smartphone, Globe, type LucideIcon } from 'lucide-react'
import type { PeriodChange, DeviceBreakdownItem, ReferrerBreakdownItem } from '@/lib/funnelStats'
...
export default function FunnelInsights({
  ...
  deviceBreakdown, referrerBreakdown, accent = '#2563eb', windowDays,
}: Props) {
