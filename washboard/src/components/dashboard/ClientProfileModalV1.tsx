...
// La fiche client, présentation v1 — reprise à l'identique du commit
// 8a1efa6 (dernier avant que cet écran passe en v2). C'est ce que voit tout
// visiteur du SITE, mobile ou ordinateur : la refonte 2026 ne s'applique
// qu'à la PWA installée (décision d'Alexandre, 2026-09-22 — voir
// ClientProfileModal.tsx, le point de branchement).
...
export default function ClientProfileModalV1({
  profile,
  onClose,
}: {
